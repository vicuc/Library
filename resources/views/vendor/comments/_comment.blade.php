...
@endif
<img class="mr-3" src="https://www.gravatar.com/avatar/{{ md5($comment->commenter->email ?? $comment->guest_email) }}.jpg?s=64" alt="{{ $comment->commenter->ten_user ?? $comment->guest_name }} Avatar">
<div class="media-body">
    <div class="media-body">
        <h5 class="mt-0 mb-1">{{ $comment->commenter->ten_user ?? $comment->guest_name }} <small class="text-muted">- {{ $comment->created_at->diffForHumans() }}</small></h5>
